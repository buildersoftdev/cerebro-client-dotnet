What is Vortex Client for .NET?
============

Vortex is an open-source distributed streaming platform designed to deliver the best performance possible for high-performance data pipelines, streaming analytics, streaming between microservices and data integrations. This library offers flexible messaging models with high-level APIs for NET.
...
* [Vortex Portal](https://github.com/buildersoftio/andyx-portal) - Dashboard for Vortex Node
* [Vortex Cli](https://github.com/buildersoftio/andyx-cli) - Manage all resources of Vortex
